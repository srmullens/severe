...
if __name__ == '__main__':
    ...
    #print(dttime(1,0))
    print('           Begin               Now                        End')
    if is_time_between(dttime(0,0),dttime(6,0),now=time): h1=1; h2=2; st=1
    elif is_time_between(dttime(6,0),dttime(7,30),now=time): h1=1; h2=3; st=1
    elif is_time_between(dttime(7,30),dttime(9,0),now=time): h1=3; h2=4; st=1
    ...
    print(f'Plot days {", ".join([str(x) for x in range(h1,h2,st)]) if h2-1-h1 else h1}')
